...
const BLOG = {
  ...
  COMMENT_ARTALK_JS:
    ...
    'https://cdnjs.cloudflare.com/ajax/libs/artalk/2.8.7/Artalk.js', // ArtalkServert js cdn
  COMMENT_ARTALK_CSS:
    process.env.NEXT_PUBLIC_COMMENT_ARTALK_CSS ||
    'https://cdnjs.cloudflare.com/ajax/libs/artalk/2.8.7/Artalk.css', // ArtalkServert css cdn
