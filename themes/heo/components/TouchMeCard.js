            ...
            <FlipCard
                ...
                frontContent={
                    <div className='h-full'>
                        ...
                        <div className='absolute left-0 top-0 w-full h-full' style={{ background: 'url(https://jsd.cdn.gitkf.com/gh/88lin/PicX@master/gzh_cover.png) center center no-repeat' }}></div>
                    </div>}
