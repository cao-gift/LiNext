            ...
            <FlipCard
                ...
                frontContent={
                    <div className='h-full'>
                        ...
                        <div className='absolute left-0 top-0 w-full h-full' style={{ background: 'url(https://files.sunguoqi.com/images/202311250251536.webp) center center no-repeat' }}></div>
                    </div>}
