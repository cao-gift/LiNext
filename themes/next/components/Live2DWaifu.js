...
export default function Live2DWife() {
  ...
  return <>
    <Head><link rel="stylesheet" href="https://jsd.cdn.zzko.cn/npm/font-awesome/css/font-awesome.min.css" /></Head>
  </>
}

function initLive2DWife() {
  // 注意：live2d_path 参数应使用绝对路径
  const live2dPath = 'https://jsd.cdn.zzko.cn/gh/stevenjoezhang/live2d-widget@latest/'
  ...
  if (screen.width >= 768) {
    Promise.all([
      ...
      initWidget({
        ...
        cdnPath: 'https://jsd.cdn.zzko.cn/gh/fghrsh/live2d_api/'
      })
    })
  }
